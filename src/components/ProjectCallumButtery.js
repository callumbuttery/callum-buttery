            ...
            <div className="flex justify-center mr-10 ml-10" data-aos="flip-left" data-aos-duration="1700" data-aos-delay="0">
                <div className="rounded-lg bg-white max-w-sm drop-shadow-4xl">
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://www.callumbuttery.dev" rel='noreferrer' target='blank' type="button" className="inline-block px-6 py-2.5 bg-cyan-500 text-white font-medium text-xs leading-tight uppercase rounded">View</a>
                    </div>
                </div>
            </div>
        </div>
