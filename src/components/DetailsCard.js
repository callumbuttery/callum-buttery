...
export default function DetailsCard() {
    return (
        <div className="w-2/6 mx-auto mt-16 shadow-lg flex justify-center bg-white drop-shadow-3xl rounded-2xl" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
            <div className="px-6 py-4">
                ...
                <div className='flex'>
                    <p className="w-5/6 mx-auto text-gray-700 text-center text-xl mt-5">
