...
export default function DetailsCard() {
    return (
        <div className="w-2/6 mx-auto mt-8 shadow-lg flex justify-center bg-white drop-shadow-3xl rounded-2xl" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
