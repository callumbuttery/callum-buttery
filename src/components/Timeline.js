export default function Timeline() {
    return (
        <section className="pt-32">
            <div data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500" className="container max-w-5xl px-4 py-12 mx-auto backdrop-blur-sm drop-shadow-3xl rounded-2xl border-solid border-2 border-white"  >
